...
class DashboardSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "owner", "owner_name", "widgets", "created_at", "updated_at",
        ]
...
class DashboardListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Dashboard
        fields = ["id", "name", "description", "is_default", "is_shared", "owner_name", "created_at"]
...
class SavedReportSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = SavedReport
        fields = [
            "id", "name", "description", "module", "filters", "fields",
            "ordering", "owner", "owner_name", "is_shared", "created_at", "updated_at",
        ]
        read_only_fields = ["id", "owner", "created_at", "updated_at"]
...
class ReportExportSerializer(serializers.ModelSerializer):
    class Meta:
        model = ReportExport
        fields = [
            "id", "report", "requested_by", "export_format", "status",
            "file", "error_message", "completed_at", "created_at",
        ]
        read_only_fields = ["id", "requested_by", "status", "file", "error_message", "completed_at", "created_at"]
