    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("conditions", models.JSONField(default=list, help_text="List of condition objects [{field, operator, value}].")),
                ("target_status", models.CharField(help_text="Value to set on the object's 'status' field when all conditions match.", max_length=50)),
