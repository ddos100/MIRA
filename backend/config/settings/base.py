...
DATABASES = {
    "default": env.db(
        "DATABASE_URL",
        default="postgres://mira:mira@localhost:5432/mira",
    )
}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "MIRA GRC API",
    "DESCRIPTION": "Managed GRC Platform – REST API",
    "VERSION": "1.0.0",
...
DEFAULT_FROM_EMAIL = env("DEFAULT_FROM_EMAIL", default="MIRA GRC <noreply@mira.local>")
